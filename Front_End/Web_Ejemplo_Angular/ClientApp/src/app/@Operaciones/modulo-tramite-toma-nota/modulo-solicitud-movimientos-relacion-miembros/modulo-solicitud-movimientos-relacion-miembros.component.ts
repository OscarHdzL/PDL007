...
import { ActualizarRepresentateTNRequest } from '../../../model/Operaciones/TomaNota/TomaNota';
import { ServiceGenerico } from '../../../services/service-generico.service';

@Component({
  selector: 'app-modulo-solicitud-movimientos-relacion-miembros',
  templateUrl: './modulo-solicitud-movimientos-relacion-miembros.component.html',
  styleUrls: ['./modulo-solicitud-movimientos-relacion-miembros.component.css'],
  providers: [ServiceGenerico]
})
/** modulo-solicitud-movimientos-relacion-miembros component*/
export class ModuloSolicitudMovimientosRelacionMiembrosComponent implements OnInit{
  ...
  @Output()
  ActualizarRepresentante: EventEmitter<ActualizarRepresentateTNRequest> = new EventEmitter<ActualizarRepresentateTNRequest>();
  @Input()
  representanteEditar: ActualizarRepresentateTNRequest;
  @Input()
  listaTipoR = [];
  formGroup: FormGroup;
  ...
  /** modulo-solicitud-movimientos-relacion-miembros ctor */
