      ...
      case 1:
        {
          ...
          if(catalogos.find(f => f.ruta === 'tramites')){
            argOrdenar.push(catalogos.find(f => f.ruta === 'tramites'));
          }

          if(catalogos.find(f => f.ruta === 'tomanota')){
            argOrdenar.push(catalogos.find(f => f.ruta === 'tomanota'));
          }


          if(catalogos.find(f => f.ruta === 'transmisiones')){
            argOrdenar.push(catalogos.find(f => f.ruta === 'transmisiones'));
          }

          if(catalogos.find(f => f.ruta === 'declaratoria-procedencia')){
