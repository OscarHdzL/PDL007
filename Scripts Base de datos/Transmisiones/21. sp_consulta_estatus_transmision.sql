 DROP FUNCTION IF EXISTS religiosos.sp_consulta_estatus_transmision(integer, integer);

CREATE OR REPLACE FUNCTION religiosos.sp_consulta_estatus_transmision(
	id_estatus integer,
...
BEGIN
	...
	IF(id_estatus = 29) THEN
		...
		WHERE cate.i_id not in (29,32,38); --33, 34
