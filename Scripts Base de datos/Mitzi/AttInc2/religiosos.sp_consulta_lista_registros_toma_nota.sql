-- FUNCTION: religiosos.sp_consulta_lista_registros_toma_nota(integer, character varying, integer, boolean, character varying, character varying, integer, integer)

-- DROP FUNCTION IF EXISTS religiosos.sp_consulta_lista_registros_toma_nota(integer, character varying, integer, boolean, character varying, character varying, integer, integer);
...
RETURN QUERY
	...
	AND (keyword IS NULL OR tblt.c_denominacion LIKE CONCAT('%',keyword,'%') 
	OR tblt.c_nregistro LIKE keyword OR tbltn.c_nfolio LIKE keyword)
	) AS main	
	ORDER BY
...
ALTER FUNCTION religiosos.sp_consulta_lista_registros_toma_nota(integer, character varying, integer, boolean, character varying, character varying, integer, integer)
    OWNER TO postgres;
