...
CREATE OR REPLACE FUNCTION religiosos.sp_consulta_lista_registros_tnota_i(
    ...
    RETURNS TABLE(id_tramite integer, id_tnota integer, nombre character varying, denominacion character varying, folio character varying, fecha_registro date, tramite_solicitado character varying, id_estatus integer, estatus character varying, fecha_autorizacion date) 
    LANGUAGE 'plpgsql'
    COST 100
