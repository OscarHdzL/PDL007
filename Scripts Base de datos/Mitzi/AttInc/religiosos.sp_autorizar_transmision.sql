-- FUNCTION: religiosos.sp_autorizar_transmision(integer, character varying, character varying, character varying, integer)
...
BEGIN
	...
	IF existeTransmision is not null  THEN
		...
		VALUES (id_transmision, 'Tramite Autorizado', false);
...
ALTER FUNCTION religiosos.sp_autorizar_transmision(integer, character varying, character varying, character varying, integer)
