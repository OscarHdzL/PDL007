-- DROP FUNCTION religiosos.sp_consulta_archivo(int4, int4);

CREATE OR REPLACE FUNCTION religiosos.sp_consulta_archivo(id_generico integer, id_archivo_tramite integer)
