-- DROP FUNCTION religiosos.sp_actualizar_tramite_paso_uno(int4, int4, int4, varchar, varchar, int4, int4, varchar, varchar, int4, varchar, varchar);

CREATE OR REPLACE FUNCTION religiosos.sp_actualizar_tramite_paso_uno(s_id integer, s_cat_credo integer, s_cat_solicitud_escrito integer, s_cat_denominacion character varying, s_numero_registro character varying, s_pais_origen integer, d_tipo_domicilio integer, d_numeroe character varying, d_numeroi character varying, d_colonia integer, d_calle character varying, p_matriz character varying)
