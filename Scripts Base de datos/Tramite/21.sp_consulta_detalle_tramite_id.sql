DROP FUNCTION IF EXISTS religiosos.sp_consulta_detalle_tramite_id(integer, integer, boolean);

CREATE OR REPLACE FUNCTION religiosos.sp_consulta_detalle_tramite_id(
	s_id_us integer,
