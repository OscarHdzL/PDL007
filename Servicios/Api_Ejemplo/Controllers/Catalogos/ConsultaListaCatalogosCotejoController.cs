...
namespace Religiosos_Api.Controllers.Catalogos
{
    ...
    [Authorize]
    public class ConsultaListaCatalogosCotejoController : Controller
    {
        #region Propiedades
        ...
        /// </summary>
        public ConsultaListaCatalogosCotejoController()
        {
        ...
        [HttpGet("[action]")]
        public async Task<IActionResult> Get(CatalogoCotejoListaRequest request)
        {
            try
            {
            ...
            {
                log.LogError("ConsultaListaCatalogosCotejoController - Get", ex);
