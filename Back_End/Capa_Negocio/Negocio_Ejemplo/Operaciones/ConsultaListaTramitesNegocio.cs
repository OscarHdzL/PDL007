...
{
    public class ConsultaListaTramitesNegocio : BaseNegocio
    {
        #region Propidades
        private readonly ConsultaListaTramitesAccesoDatos _AccesoDatos;
        #endregion
        ...
        /// Constructor Inicial 
        /// </summary>
        public ConsultaListaTramitesNegocio()
            : base()
        {
            _AccesoDatos = new ConsultaListaTramitesAccesoDatos();
        }
        #endregion
