...
{
    public class ConsultaDetalleCotejoNegocio : BaseNegocio
    {
        #region Propidades
        private readonly ConsultaDetalleCotejoAccesoDatos _AccesoDatos;
        #endregion
        ...
        /// </summary>
        public ConsultaDetalleCotejoNegocio()
            : base()
        {
            _AccesoDatos = new ConsultaDetalleCotejoAccesoDatos();
        }
        #endregion
        ...
        public async Task<ResponseGeneric<List<ConsultaDetalleCotejoResponse>>> Consultar(ConsultaDetalleCotejoRequest entidad)
        {
            ...
            {
                LogErrores("Negocio ConsultaDetalleCotejoNegocio", ex);
                throw;
            }
        }
        /// <summary>
