...
namespace Negocio.Operaciones
{
    ...
    /// </summary>
    public class ActualizarCotejoNegocio : BaseNegocio
    {
        #region Propidades
        private readonly ActualizarCotejoAccesoDatos _accesoAdatos;
        ...
        /// Constructor Inicial 
        /// </summary>
        public ActualizarCotejoNegocio()
            : base()
        {
            _accesoAdatos = new ActualizarCotejoAccesoDatos();
        ...
        public async Task<ResponseGeneric<List<ActualizarCotejoResponse>>> Operacion(ActualizarCotejoRequest request)
        {
            ...
            {
                LogErrores("ActualizarCotejoNegocio - Operacion", ex);
                throw;
            }
        }
