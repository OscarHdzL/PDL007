...
{
    public class ActualizarAtenderCotejoTomaNotaNegocio : BaseNegocio
    {
        #region Propidades
        private readonly ActualizarAtenderCotejoTomaNotaAccesoDatos _accesoAdatos;
        ...
        /// Constructor Inicial 
        /// </summary>
        public ActualizarAtenderCotejoTomaNotaNegocio()
            : base()
        {
            _accesoAdatos = new ActualizarAtenderCotejoTomaNotaAccesoDatos();
        ...
        public async Task<ResponseGeneric<List<ActualizarCotejoResponse>>> Operacion(ActualizarCotejoRequest request)
        {
            ...
            {
                LogErrores("ActualizarAtenderCotejoTomaNotaNegocio - Operacion", ex);
                throw;
            }
        }
        ...
        /// <summary>
        /// Obtener los datos del usuario para mandar una noid¿ficación
        /// </summary>
        /// <param name="entidad"></param>
        /// <returns></returns>
