...
{
    public class ConsultaListaCatalogoPaisoNegocio : BaseNegocio
    {
        #region Propidades
        private readonly ConsultaListaCatalogoPaisoAccesoDatos _AccesoDatos;
        #endregion
        ...
        /// Constructor Inicial 
        /// </summary>
        public ConsultaListaCatalogoPaisoNegocio()
            : base()
        {
            _AccesoDatos = new ConsultaListaCatalogoPaisoAccesoDatos();
        }
        #endregion
