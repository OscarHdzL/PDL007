...
namespace Negocio.Catalogos
{
    ...
    /// </summary>
    public class InsertarCatalogoCnotarioarrNegocio : BaseNegocio
    {
        #region Propidades
        private readonly InsertarCatalogoCnotarioarrAccesoDatos _accesoAdatos;
        #endregion
        ...
        /// Constructor Inicial 
        /// </summary>
        public InsertarCatalogoCnotarioarrNegocio()
            : base()
        {
            _accesoAdatos = new InsertarCatalogoCnotarioarrAccesoDatos();
        }
        #endregion
        ...
        public async Task<ResponseGeneric<List<CatalogoCnotarioarrInsertResponse>>> Operacion(CatalogoCnotarioarrInsertRequest[] request)
        {
            ...
            {
                LogErrores("CatalogoCnotarioarrInsertNegocio - Operacion", ex);
                throw;
            }
        }
        #endregion
