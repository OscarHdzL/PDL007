...
{
    public class ConsultaListaTipoRepresentanteNegocio : BaseNegocio
    {
        #region Propidades
        private readonly ConsultaListaTipoRepresentanteAccesoDatos _AccesoDatos;
        #endregion
        ...
        /// Constructor Inicial 
        /// </summary>
        public ConsultaListaTipoRepresentanteNegocio()
            : base()
        {
            _AccesoDatos = new ConsultaListaTipoRepresentanteAccesoDatos();
        }
        #endregion
