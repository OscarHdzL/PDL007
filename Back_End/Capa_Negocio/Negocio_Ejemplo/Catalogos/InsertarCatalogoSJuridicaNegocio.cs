...
namespace Negocio.Catalogos
{
    ...
    /// </summary>
    public class InsertarCatalogoSJuridicaNegocio : BaseNegocio
    {
        #region Propidades
        private readonly InsertarCatalogoSJuridicaAccesoDatos _accesoAdatos;
        #endregion
        ...
        /// Constructor Inicial 
        /// </summary>
        public InsertarCatalogoSJuridicaNegocio()
            : base()
        {
            _accesoAdatos = new InsertarCatalogoSJuridicaAccesoDatos();
        }
        #endregion
        ...
        public async Task<ResponseGeneric<List<CatalogoSJuridicaInsertResponse>>> Operacion(CatalogoSJuridicaInsertRequest[] request)
        {
            ...
            {
                LogErrores("CatalogoSJuridicaInsertNegocio - Operacion", ex);
                throw;
            }
        }
        #endregion
