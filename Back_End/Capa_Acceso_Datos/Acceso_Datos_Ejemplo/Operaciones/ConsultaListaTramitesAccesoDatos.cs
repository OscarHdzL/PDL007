...
{
    public class ConsultaListaTramitesAccesoDatos : BaseAccesoDatos
    {
        #region SP_Operaciones
        private const string sp_consulta_conteo_colonia_async = "religiosos.sp_consulta_registros_conteo";
        private const string sp_consulta_lista_colonias = "religiosos.sp_consulta_lista_registros";
        #endregion
        ...
        /// </summary>
        public ConsultaListaTramitesAccesoDatos()
            : base() { }
        #endregion

        #region Parametros SQL
        private List<EntidadParametro> ObtenerParametrosDT(ConsultaListaTramitesAsignadorRequest request)
        {
        ...
        /// <param name="request">Objeto de tranporte de la solicitud</param>
        /// <returns></returns>
        public async Task<ResponseGeneric<List<ConteoTramitesResponse>>> Conteo(ConsultaListaTramitesRequest request)
        {
