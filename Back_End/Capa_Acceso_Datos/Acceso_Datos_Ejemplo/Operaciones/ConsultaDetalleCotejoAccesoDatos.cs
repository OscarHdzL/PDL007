...
{
    public class ConsultaDetalleCotejoAccesoDatos : BaseAccesoDatos
    {
        #region SP_Operaciones
        private const string sp_consulta_detalle_usuarios_sistema = "religiosos.sp_consulta_detalle_cotejo";
        private const string sp_consulta_detalle_publico = "religiosos.sp_consulta_detalle_cotejo_publico_new";
        #endregion
        ...
        /// </summary>
        public ConsultaDetalleCotejoAccesoDatos()
            : base() { }
        #endregion
        ...
        public async Task<ResponseGeneric<List<ConsultaDetalleCotejoResponse>>> Consultar(ConsultaDetalleCotejoRequest request)
        {
            ...
            {
                LogErrores("AccesoDatos ConsultaDetalleCotejoAccesoDatos", ex);
                throw;
            }
        }
        /// <summary>
        ...
        public async Task<ResponseGeneric<List<ConsultaDetalleCotejoPublicoResponse>>> Consultar(ConsultaDetalleCotejoPublicoRequest request)
        {
            ...
            try
            {
                using (var conexion = new Contexto())
                {
                    ...
                    {
                        case 1:
                            var resulMySQL = StoreProcedureParametros.ParametrosMySQL(ObtenerParametrosPublico(request), sp_consulta_detalle_publico);
                        ...
                        case 2:
                            var resulPostgreSQL = StoreProcedureParametros.ParametrosPostgreSQL(ObtenerParametrosPublico(request), sp_consulta_detalle_publico, tipo: "SELECT * FROM");
