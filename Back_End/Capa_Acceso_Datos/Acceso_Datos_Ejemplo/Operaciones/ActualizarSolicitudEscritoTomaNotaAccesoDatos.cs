...
{
    public class ActualizarSolicitudEscritoTomaNotaAccesoDatos : BaseAccesoDatos
    {
        #region SP_Operaciones
        private const string sp_insertar_usuario_sistema = "religiosos.sp_actualizar_solicitud_escrito_toma_nota";
        #endregion
        ...
        /// </summary>
        public ActualizarSolicitudEscritoTomaNotaAccesoDatos()
            : base() { }
        #endregion
        ...
        private List<EntidadParametro> ObtenerParametros(ActualizarSolicitudEscritoTomaNotaRequest request)
        {
            return new List<EntidadParametro>
            {
                ...
                new EntidadParametro { Nombre = "s_id", Tipo = "Int", Valor = request.tomanota },
                new EntidadParametro { Nombre = "se_id", Tipo = "Int", Valor = request.solicitudescrito },
            };
        }
        #endregion
        ...
        public async Task<ResponseGeneric<List<ActualizarSolicitudEscritoTomaNotaResponse>>> Operacion(ActualizarSolicitudEscritoTomaNotaRequest request)
        {
            ...
            {
                LogErrores("ActualizarSolicitudEscritoTomaNotaAccesoDatos", ex);
                throw;
            }
        }
        #endregion
