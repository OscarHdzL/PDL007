...
{
    public class ConsultaListaCatalogoTSolRegAccesoDatos : BaseAccesoDatos
    {
        #region SP_Operaciones
        private const string sp_consulta_lista_convocatorias = "religiosos.sp_consulta_lista_catalogos_TSolReg";
        #endregion
        ...
        /// </summary>
        public ConsultaListaCatalogoTSolRegAccesoDatos()
            : base() { }
        #endregion
        ...
        public async Task<ResponseGeneric<List<ConsultaListaCatalogoTSolRegaResponse>>> Consultar(CatalogoSolicitudEscritoListaRequest request)
        {
            ...
            {
                LogErrores("ConsultaListaCatalogoSolicitudEscritoAccesoDatos", ex);
                throw;
            }
        }
        #endregion
