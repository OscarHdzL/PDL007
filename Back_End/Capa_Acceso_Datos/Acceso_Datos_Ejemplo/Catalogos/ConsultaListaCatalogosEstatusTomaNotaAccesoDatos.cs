...
{
    public class ConsultaListaCatalogosEstatusTomaNotaAccesoDatos : BaseAccesoDatos
    {
        #region SP_Operaciones
        private const string sp_consulta_lista_convocatorias = "religiosos.sp_consulta_lista_estatus_toma_nota";
        #endregion
        ...
        /// </summary>
        public ConsultaListaCatalogosEstatusTomaNotaAccesoDatos()
            : base() { }
        #endregion
        ...
        public async Task<ResponseGeneric<List<ConsultaListaEstatusResponse>>> Consultar(CatalogoEstatusListaRequest request)
        {
            ...
            {
                LogErrores("ConsultaListaCatalogosEstatusTomaNotaAccesoDatos Estatus", ex);
                throw;
            }
        }
        #endregion
